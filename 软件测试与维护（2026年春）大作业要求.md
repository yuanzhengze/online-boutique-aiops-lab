...
> 论文地址如下：
> KPI Anomaly Detection：[KPI Anomaly Detection](https://nankai.feishu.cn/drive/folder/fldcn0y9boSvEx9z7bJHNFqidu5)
> 
> Log Anomaly Detection：[Log Anomaly Detection](https://nankai.feishu.cn/drive/folder/fldcn7AlrwMen8ctciVklXMJ1tf)
> 
> Trace Anomaly Detection:  [Trace Anomaly Detection](https://nankai.feishu.cn/drive/folder/OTz4f3xSrl05P8d3sREcaKaxnVd)
> 
> Failure Diagnosis：[Failure Diagnosis](https://nankai.feishu.cn/drive/folder/fldcnBhNccepN6Z0LBIFxYvn0Qg)
> 
> 
...
2. 第二档：自行选择其他**更复杂的开源微服务系统**\( [TrainTicket](https://github.com/FudanSELab/train-ticket/)、[Online\-Boutique](https://github.com/JoinFyc/Online-Boutique)、[Hotel\-Reservation](https://github.com/delimitrou/DeathStarBench/tree/master/hotelReservation)、[Social\-Network](https://github.com/delimitrou/DeathStarBench/tree/master/socialNetwork)、[Media\-Microservices](https://github.com/delimitrou/DeathStarBench/tree/master/mediaMicroservices) \)进行部署、监控和维护。
...
2. 加分项二：封装**智能体**自动进行智能运维（可自主选择实现故障注入与验证、异常检测、根因分类、故障恢复等操作中的一项或多项）（具体流程可参考：[使用智能体进行智能运维](https://nankai.feishu.cn/wiki/AuPtwvDlKinPaskYVubcWoLancd?from=from_copylink)）。
